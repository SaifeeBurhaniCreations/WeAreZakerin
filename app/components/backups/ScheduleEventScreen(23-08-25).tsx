  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={[styles.HStack, { marginTop: 12, justifyContent: 'space-between' }]}>
          <Button onPress={() => {createEventModalRef.current?.open(); setIsInstant(true)}} variant="fill" size="md">Instant Miqaat</Button>
      ...
      <BottomSheetModal
        ...
        ref={modalRef}
        onPress={() => {createEventModalRef.current?.open(); setIsInstant(false)}}
        footer="Assign Party"
